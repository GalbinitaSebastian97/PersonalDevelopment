#include "MirrorFoldServiceSkeleton.hpp"
...
// ── now getController() can be defined here where the type is complete ────────
FramelessFoldController& MirrorFoldServiceSkeleton::getController()
{
    return *m_controller;
}
